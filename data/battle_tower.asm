...
BattleTowerMons1:
	...
	db MR__MIME
	db QUICK_CLAW
	db TOXIC, PSYCH_UP, FIRE_PUNCH, MOONBLAST
	dw 0 ; OT ID
	dt 1000 ; Exp
	; Stat exp
	bigdw 30000
...
BattleTowerMons2:
	...
	db WIGGLYTUFF
	db GOLD_BERRY
	db DAZZLINGLEAM, BLIZZARD, FIRE_BLAST, ATTRACT
	dw 0 ; OT ID
	dt 8000 ; Exp
	; Stat exp
	bigdw 40000
	...
	db WIGGLYTUFF
	db PINK_BOW
	db PSYCHIC_M, SWAGGER, PSYCH_UP, MOONBLAST
	dw 0 ; OT ID
	dt 8000 ; Exp
	; Stat exp
	bigdw 30000
...
BattleTowerMons8:
	...
	db GRANBULL
	db BRIGHTPOWDER
	db ROAR, SHADOW_BALL, DAZZLINGLEAM, THUNDERPUNCH
	dw 0 ; OT ID
	dt 512000 ; Exp
	; Stat exp
	bigdw 30000
