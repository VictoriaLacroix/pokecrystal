...
ENDM
	...
	move FUTURE_SIGHT, EFFECT_FUTURE_SIGHT,       90, PSYCHIC,   95, 15,   0
	move ROCK_SMASH,   EFFECT_DEFENSE_DOWN_HIT,   20, FIGHTING, 100, 15,  50
	move WHIRLPOOL,    EFFECT_BIND,               15, WATER,     70, 15,   0
	move BEAT_UP,      EFFECT_BEAT_UP,            10, DARK,     100, 10,   0
        move DAZZLINGLEAM, EFFECT_NORMAL_HIT,        120, FAIRY_T,   85, 10,   0
        move MOONBLAST,    EFFECT_SP_ATK_DOWN_HIT,    95, FAIRY_T,  100, 15,  10
